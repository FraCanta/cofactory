        ...
        >
          <div className="flex flex-col col-span-2 gap-10">
            <div className="flex flex-col justify-between">
              <h1
                className={`font-clear dark:text-third text-white text-4xl md:text-6xl lg:text-4xl 2xl:text-[3.3rem] flex flex-wrap items-center gap-2 md:gap-4 2xl:gap-4`}
              >
                {work.brand1}
            ...
            <div className="flex items-center justify-between ">
              <p
                className={`font-raleway dark:text-third text-white text-base md:text-xl lg:text-lg  2xl:text-xl  flex  gap-4 h-full`}
              >
                {work.descrizione}
              </p>
            </div>
          ...
          <div className="z-10 grid grid-cols-1 gap-6">
            <div className="flex flex-col space-y-1 ">
              <h2
                className={`font-raleway text-second text-base md:text-[3.2vw] lg:text-[1.8vw] 2xl:text-lg font-normal lowercase `}
              >
                {work.partner}
              </h2>
              <h3
                className={`font-raleway dark:text-third text-white text-base font-normal uppercase `}
              >
                {work.year}
              </h3>
            </div>
            ...
            <div className="flex flex-col items-start justify-between h-full ">
              <div
                className={`font-raleway  flex flex-wrap  gap-2 dark:text-third text-white  text-sm md:text-base lg:text-sm uppercase`}
              >
          ...
          <div className="w-[90%] mx-auto flex flex-col gap-6">
            {work.row0 ? (
              <div data-aos="fade-up" data-aos-delay="100">
                ...
                >
                  <p
                    className={`font-raleway dark:text-third text-white/80 text-base md:text-[3vw] lg:text-xl lg:w-[75%] mx-auto flex leading-normal  gap-4 h-full`}
                  >
                    {work.row0.paragrafo}
                  </p>
                </div>
            ...
            {work.row1bis ? (
              <div data-aos="fade-up" data-aos-delay="100">
                ...
                >
                  <p
                    className={`font-raleway dark:text-third text-white text-base md:text-xl lg:text-lg  2xl:text-xl lg:w-[75%] lg:mx-auto  flex  gap-4 h-full`}
                  >
            ...
            {work.row2 ? (
              ...
              >
                {work.row2.title ? (
                  <h2
                    className={`font-clear dark:text-third text-white text-6xl md:text-7xl  lg:text-8xl 2xl:text-9xl py-10 lg:py-0`}
                  >
                    {work.row2.title.primo}
                    <span className={`font-clear text-[#d51d1f]`}>
            ...
            {work.limited ? (
              ...
              >
                <h2
                  className={`font-clear dark:text-third text-white text-4xl lg:text-6xl py-10 lg:py-0`}
                >
                  {work.limited.primo}
                  <span className={`font-clear text-[#d51d1f]`}>
                    {work.limited.due}
            ...
            {work.row4 ? (
              <>
                ...
                >
                  <h3
                    className={`font-clear dark:text-third text-white text-[8.5vw] md:text-[6vw] lg:text-3xl `}
                  >
                    {work.row4.title}
                  </h3>
                  <p
                    className={`font-raleway dark:text-third text-white/80 text-[5vw] md:text-[3vw] lg:text-xl lg:w-[60%] mx-auto flex leading-normal  gap-4 h-full`}
                  >
            ...
            {work.row8 ? (
              <div data-aos="fade-up" data-aos-delay="100">
                ...
                >
                  <h3
                    className={`font-clear dark:text-third text-white text-2xl md:text-5xl lg:text-4xl `}
                  >
                    {work.row8.title}
                  </h3>
                  <p
                    className={`font-raleway dark:text-third text-white/80 text-base md:text-xl lg:text-xl lg:w-[75%] mx-auto `}
                  >
            ...
            {work.row8bis ? (
              <div data-aos="fade-up" data-aos-delay="100">
                ...
                >
                  <h2
                    className={`font-clear dark:text-third text-white text-4xl lg:text-5xl py-10 md:py-6 lg:py-0`}
                  >
                    {work.row8bis.title.uno}
                    <span className={`font-clear text-[#96be25]`}>
                      {work.row8bis.title.due}
                    </span>{" "}
                    <span className={`font-clear text-white`}>
                      {work.row8bis.title.tre}
                    </span>{" "}
                  </h2>
                  <div className="flex flex-col gap-4">
                    <p
                      className={`font-raleway dark:text-third text-white/80 text-base md:text-xl lg:text-xl lg:w-[65%] mx-auto `}
                    >
