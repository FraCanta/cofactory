...
import CasoImg from "@/public/assets/cases/milka/cover_milka.png";
...
import Grid1 from "@/public/assets/cases/milka/milka1.jpg";
import Grid2 from "@/public/assets/cases/milka/milka2.png";
import Grid5 from "@/public/assets/cases/milka4.jpg";
import Grid6 from "@/public/assets/cases/milka5.jpg";
import Mockup from "@/public/assets/cases/milka/mockup.png";
import Mockup2 from "@/public/assets/cases/milka/mockup2.png";
import Notch from "@/public/assets/cases/milka/notch.png";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-gradient-to-50 aspect-square rounded-[15px] relative overflow-hidden w-full">
              <Image
                src={Mockup}
                alt=""
                className="w-[280px] lg:w-[600px] absolute bottom-20 lg:bottom-36 left-10 lg:left-28 translate-y-1/2 z-10"
              />

              <motion.div
                className="w-[280px] lg:w-[600px] absolute -bottom-[5px] lg:-bottom-[420px] left-10 lg:left-28 translate-y-1/2 overflow-hidden"
                style={{ zIndex: 5 }}
